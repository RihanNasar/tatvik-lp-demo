    ...
    <section ref={container} className="w-full h-[100dvh] bg-transparent flex flex-col items-center justify-center px-6 relative z-20 overflow-hidden perspective-[2000px]">
      ...
      <div className="w-full max-w-5xl h-full relative [transform-style:preserve-3d]">
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center w-full">
          <div className="feature-panel pointer-events-auto w-full flex flex-col md:flex-row items-center gap-6 md:gap-12 p-6 md:p-8 bg-white/[0.02] border border-white/5 backdrop-blur-2xl rounded-3xl shadow-[0_0_50px_rgba(0,191,255,0.1)] max-h-[85vh] overflow-y-auto overflow-x-hidden">
        ...
        {/* Panel 2 */}
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center w-full">
          <div className="feature-panel pointer-events-auto w-full flex flex-col md:flex-row items-center gap-6 md:gap-12 p-6 md:p-8 bg-white/[0.02] border border-white/5 backdrop-blur-2xl rounded-3xl shadow-[0_0_50px_rgba(155,48,255,0.1)] max-h-[85vh] overflow-y-auto overflow-x-hidden">
            <div className="flex-1 w-full">
        ...
        {/* Panel 3 */}
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center w-full">
          <div className="feature-panel pointer-events-auto w-full flex flex-col md:flex-row items-center gap-6 md:gap-12 p-6 md:p-8 bg-white/[0.02] border border-white/5 backdrop-blur-2xl rounded-3xl shadow-[0_0_50px_rgba(242,165,49,0.1)] max-h-[85vh] overflow-y-auto overflow-x-hidden">
            <div className="flex-1 w-full">
